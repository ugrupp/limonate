...
const Imprint: NextPage<InferGetStaticPropsType<typeof getStaticProps>> = ({
  ...
  return (
    <div className="grid xl:grid-cols-2 gap-y-60 md:gap-y-90 gap-x-40 2xl:gap-x-60">
      {/* Col 1 */}
      <div>
        <h1 className="text-16 md:text-20 3xl:text-25 leading-tight uppercase mb-[1.25em]">
          {data.title}
        </h1>

        <h2 className="text-16 md:text-20 3xl:text-25 leading-tight uppercase mb-[1.25em]">
          {data.col1.intro}
        </h2>
        ...
        <div
          className={[
            richtextStyles.root,
            "font-serif text-25 md:text-40 xl:text-35 3xl:text-55 leading-none",
          ].join(" ")}
      ...
      <div>
        <div
          className={[
            richtextStyles.root,
            "text-16 md:text-20 3xl:text-25 leading-tight",
          ].join(" ")}
